...
/**
 * VOITURE AVEC CONSTRUCTEUR PARAMETRE ET UN CONSTRUCTEUR PAR DEFAUT EXPLICITE
 */
public class Voiture3 {
    ...
    public Voiture3(String nomDeLaMarque, String nomDuModele, int nombreDePortes, int nombreDesPlaces, int nombreDeCv) {
        this.nomDeLaMarque = nomDeLaMarque;
        this.nomDuModele = nomDuModele;
        this.nombreDePortes = nombreDePortes;
        this.nombreDesPlaces = nombreDesPlaces;
        this.nombreDeCv = nombreDeCv;
    }
